            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $report->date->translatedFormat('d F Y') }}"
                                readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="card-footer bg-white border-0 d-flex justify-content-end gap-2 px-0 pt-3">
                    ...
                    @if ($report->status === 'active')
                     <a  href="{{ route('reports.print', $report->id) }}" class="btn btn-success" target="_blank">
            ...
            <div class="modal-content rounded-4 shadow-lg border-0 p-2">
                <div class="modal-header border-0 pb-0">
                    <div class="d-flex align-items-center gap-2 w-100">
                        ...
                        <div class="grow">
                            <h5 class="modal-title mb-0 fw-bold text-danger">Batalkan Laporan</h5>
                ...
                <div class="modal-body pt-3 pb-0 px-4">
                    <p class="mb-3 fs-6">Batalkan laporan tanggal <strong>{{ $report->date->translatedFormat('d F Y') }}</strong>
                        untuk kendaraan <strong>{{ $report->vehicle->nopol }}</strong>?</p>
                </div>
                <div class="modal-footer border-0 pt-0 px-4 pb-4 d-flex justify-content-end gap-2">
                    ...
                    <form action="{{ route('reports.update', $report) }}" method="POST" class="d-inline">
                        ...
                        <button type="submit" class="btn btn-danger px-4 btn-delete-report">
                            <span class="button-content"> Ya</span>
